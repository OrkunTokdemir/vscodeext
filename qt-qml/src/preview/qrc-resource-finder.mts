...
export class QrcResourceFinder {
   ...
   */
  async findResource(qrcPath: string): Promise<QrcResource | undefined> {
   ...
   */
  private async buildResourceMap(): Promise<void> {
   ...
   */
  private async findAllQrcFiles(): Promise<vscode.Uri[]> {
   ...
   */
  private processQrcFile(qrcFilePath: string): void {
    try {
   ...
   *   etc.
   */
  private synthesizeDirectories(): void {
   ...
   */
  getAllResources(): Map<string, QrcResource> {
